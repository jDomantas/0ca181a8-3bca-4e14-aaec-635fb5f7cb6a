...
namespace _0ca181a8_3bca_4e14_aaec_635fb5f7cb6a.UI
{
    class UnholySlider
    {
            ...
            : this(x, y, w, h, maxPercentage)
        {
            _bars = intervals
                    .Select(i => (int)(i * w + x))
                    .Select(c => new Button(Resources.Slider, Resources.SliderHover, c - BarWidth / 2, (int)_position.Y, BarWidth, (int)_size.Y))
                    .ToList();
        }
        ...
        public void Update()
        {
            ...
            else if(_hoveredBar == null)
            {
                ...
                {
                    // add bar
                    var bar = new Button(Resources.Slider, Resources.SliderHover, mousePoint.X - BarWidth / 2, (int)_position.Y, BarWidth, (int)_size.Y);
